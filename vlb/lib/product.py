...
class Product():
	...
	def __init__(self, data):
		...
		try:
			...
			self.id = 'JSON could not be decoded'
			self.title = 'JSON could not be decoded'
			self.isbn = 'JSON could not be decoded'
			self.availability = 'JSON could not be decoded'
			self.availability_desc = 'JSON could not be decoded'
			self.prices = 'JSON could not be decoded'
			self.price_DE = 'JSON could not be decoded'
			self.price_AT = 'JSON could not be decoded'
			self.price_CH = 'JSON could not be decoded'
			self.front_cover = 'JSON could not be decoded'
